 ...
 * @author chenjw
 */
public interface WxQrCodeClient {
     ...
     */
    byte[] qrCode(String appId, String scene, String page, int width);
     ...
     * @throws WxErrorException 异常
     */
    String qrCodeBase64(String appId, String scene, String page, int width);
     ...
     * @throws WxErrorException 异常
     */
    String qrCodeBase64(String appId, QrCodeGenerateParam param);
